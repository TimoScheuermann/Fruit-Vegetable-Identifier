...
const APRICOT: FVIClass = {
  ...
  information: [
    'Die getrocknete Aprikosen helfen dir bei der Gewichtsabnahme, da die Konzentration der Nährstoffe höher ist, brauchst du auch nur eine kleiner Portion um dein Sättigungsgefühl zu erreichen. Somit optimal als Snack während der Diät zwischendurch.'
  ],
  nutrition: {
    calories: '48 kcal',
    carbs: '10 g',
...
const BANANA: FVIClass = {
  ...
  information: [
    '2016 wurde in China ein neues Gesetz verabschiedet, das es verbietet, im Livestream auf verführerische Art Bananen zu essen.'
  ],
  nutrition: {
    calories: '93 kcal',
    carbs: '20 g',
...
const CANTALOUPE: FVIClass = {
  ...
  information: [
    'Es gibt Wassermelonen und es gibt Zuckermelonen. Von Zuckermelonen gibt es rund 500 verschiedene Sorten, die beliebteste darunter ist die Cantaloupe.'
  ],
  nutrition: {
    calories: '35 kcal',
    carbs: '8 g',
...
const COCOS: FVIClass = {
  ...
  information: [
    'Um herauszufinden, ob eine Kokosnuss noch frisch ist, musst Du sie einfach schütteln. Hört sich die Frucht voll an und es „schwappt“, ist die Nuss noch frisch. Je älter sie ist, desto weniger Flüssigkeit enthält sie!'
  ],
  nutrition: {
    calories: '354 kcal',
    carbs: '15 g',
...
const LIME: FVIClass = {
  ...
  information: [
    'Das Wichtigste für fitnessbewusste Urlauber: Low Carb Caipirinha-> 6 cl Cachaca (Pitù), 1 Limette, 2 EL Erythrit oder Kokosblütenzucker, 5 EL Crushed Ice. Cheers!'
  ],
  nutrition: {
    calories: '48 kcal',
    carbs: '1.9 g',
...
const LYCHEE: FVIClass = {
  ...
  information: [
    'In Südchina konnte man vor vielen vielen Jahren in manchen Gegenden mit Litchis bezahlen. Wir wetten dass einige auch Rambutans benutzt haben.'
  ],
  nutrition: {
    calories: '76 kcal',
    carbs: '17 g',
...
const MARACUJA: FVIClass = {
  ...
  information: [
    'Das Passionsfrucht hat eine violette Hülle. Die Maracuja dagegen ist die gelbe Passionsfrucht, das auch säurehaltiger ist.'
  ],
  nutrition: {
    calories: '67 kcal',
    carbs: '9.5 g',
...
const PAPAYA: FVIClass = {
  ...
  information: [
    'Die Papayakerne kannst Du ganz toll zum Würzen einsetzen und sie sind ein klasse Pfefferersatz. Sie schmecken milder als Pfeffer und auch aromatischer.'
  ],
  nutrition: {
    calories: '43 kcal',
    carbs: '7.2 g',
...
const PEAR: FVIClass = {
  ...
  information: [
    'Wie passt die Birnensorte „Williams Christ“ in Spirituosen-Flaschen? Den noch ganz kleinen Früchten werden am Baum Flaschen übergestülpt und am Zweig befestigt. Die Birne wächst dann in der Flasche weiter bis zur Reife. Nach der Entfernung vom Zweig wird der Schnaps zugegossen.'
  ],
  nutrition: {
    calories: '52 kcal',
    carbs: '12.4 g',
...
const PINEAPPLE: FVIClass = {
  ...
  information: [
    'Die Ananas ist ein echter Stimmungsaufheller. So enthält sie natürliches Vanillin, das anregend und euphorisierend wirken soll. Die ebenfalls enthaltene Aminosäure Tryptophan, die Vorstufe des sogenannten Glückshormons Serotonin, sorgt für Ausgeglichenheit und gute Laune.'
  ],
  nutrition: {
    calories: '57 kcal',
    carbs: '12.4 g',
...
const POMELO: FVIClass = {
  ...
  information: [
    'Dank des Inhaltstoffes Naringin senkt der Verzehr von Pomelos den Blutdruck und stärkt unsere Gefäße.'
  ],
  nutrition: {
    calories: '80 kcal',
    carbs: '19 g',
...
const RASPBERRY: FVIClass = {
  ...
  information: [
    'Russland ist der größte Himbeerhersteller der Welt. Pro Jahr werden etwa 125.000 Tonnen Himbeeren produziert.'
  ],
  nutrition: {
    calories: '34 kcal',
    carbs: '4.8 g',
...
const BEETROOT: FVIClass = {
  ...
  information: [
    'Ein Glas Rote-Bete-Saft am Tag enthält genug Kieselsäure, um unsere Nägel zu stärken und die Haarwurzeln nachweislich zu festigen.'
  ],
  nutrition: {
    calories: '42 kcal',
    carbs: '8.4 g',
...
const BELLPEPPER: FVIClass = {
  ...
  information: [
    'Früher gab es tatsächlich nur scharfe Paprika. Erst in den 1950er Jahren wurden in Ungarn die ersten süße Paprika gezüchtet.'
  ],
  nutrition: {
    calories: '37 kcal',
    carbs: '6.4 g',
...
const BLUEBERRY: FVIClass = {
  ...
  information: [
    'Medizinische Studien haben gezeigt, dass die aus Heidelbeeren isolierten Substanzen die Augenfunktion verbessern und die Durchblutung der Netzhaut beschleunigen.'
  ],
  nutrition: {
    calories: '42 kcal',
    carbs: '7.4 g',
...
const CACTUS_FRUIT: FVIClass = {
  ...
  information: [
    'Die Inhaltsstoffe von Kaktusfeigen, können Fett binden und blockieren. Aufgrund ihrer Bindungsaffinität sorgen sie dafür, dass der Körper Nahrungsfette nicht als unschöne Fettdepots an Bauch und Hüfte lagert, sondern unverdaut wieder abgibt.'
  ],
  nutrition: {
    calories: '46 kcal',
    carbs: '7.1 g',
...
const CARAMBOLA: FVIClass = {
  ...
  information: [
    'Lecker aber tödlich: Für Nierenkranke sind Sternfrüchte tabu. Denn die auch Karambole genannte Frucht enthält ein Nervengift, das gesunden Menschen nicht schadet, bei Nierenkranken aber schwere Vergiftungen auslösen kann.'
  ],
  nutrition: {
    calories: '31 kcal',
    carbs: '6.7 g',
...
const CAULIFLOWER: FVIClass = {
  ...
  information: [
    'Blumenkohl ist der Papi von Romanesco - aufgrund der Verwandtschaft mit dem Brokkoli konnte durch die Kreuzung von Blumenkohl und Brokkoli die Sorte Romanesco, auch bekannt als grüner Blumenkohl, gezüchtet werden'
  ],
  nutrition: {
    calories: '28 kcal',
    carbs: '2.3 g',
...
const CHESTNUT: FVIClass = {
  ...
  information: [
    'Die kleinen Kraftpakete enthalten sämtliche B-Vitamine (toll für die Haare), Vitamin E und C, das Provitamin A, hochwertiges Eiweiß und eine ganze Riege wichtiger Mineralstoffe und Spurenelemente wie Kalium, Calcium (die Zähne schreien Hurra), Phosphor, Schwefel, Eisen, Magnesium, Kupfer und Mangan.'
  ],
  nutrition: {
    calories: '175 kcal',
    carbs: '40 g',
...
const CORN: FVIClass = {
  ...
  information: [
    'Umweltheld - 1 ha Maisanbau "recycelt" den CO2-Ausstoß von 60.000 km Autofahrt bzw. vier Pkw "Durchschnittsfahrern" '
  ],
  nutrition: {
    calories: '109 kcal',
    carbs: '15.7 g',
...
const CUCUMBER: FVIClass = {
  ...
  thumbnail:
    'https://images.unsplash.com/photo-1552318744-8cdc310db580?w=1920&q=20',
  information: [
    'Nicht rumgurken. Trainieren! Weil wir so nett sind hier noch extra Klugscheißerwissen für Dich: Es kann einen Unterschied von 20 ° zwischen der Innenseite einer Gurke und der tatsächlichen Außentemperatur geben. Es wird angenommen, dass dies der Ursprung der Wendung „Cool wie eine Gurke“ ist.'
  ],
  nutrition: {
    calories: '16 kcal',
    carbs: '1.8 g',
...
const EGGPLANT: FVIClass = {
  ...
  information: [
    'Die Leute nannten die Pflanze „Eggplant“, weil bestimmte Sorten weiße Früchte von ovaler Form produzieren, die wie Hühnereier aussehen.'
  ],
  nutrition: {
    calories: '25 kcal',
    carbs: '2.6 g',
...
const FIG: FVIClass = {
  ...
  information: [
    'Schon in der Bibel spielen Feigen eine wichtige Rolle, nämlich im Garten Eden, als einzige Frucht neben dem Apfel. Nachdem Adam und Eva vom „Baum der Erkenntnis“ gegessen hatten, bedeckten sie sich mit Feigenblättern.'
  ],
  nutrition: {
    calories: '63 kcal',
    carbs: '12.9 g',
...
const GINGER: FVIClass = {
  ...
  information: [
    'Laut einer Studie der University of Georgia mildert Ingwer Muskelkater. Außerdem kurbelt er unseren Stoffwechsel an, was beim Abnehmen förderlich sein kann.'
  ],
  nutrition: {
    calories: '70 kcal',
    carbs: '13 g',
...
const KOHLRABI: FVIClass = {
  ...
  information: [
    'Auf 100 Gramm des Wintergemüses kommen 322 Milligramm Kalium und 63 Milligramm Vitamin C, das ist mehr als bei mancher Obstsorte. Außerdem liefert die Knolle eine große Menge Phosphor - ein wichtiger Baustein für gesunde Knochen.'
  ],
  nutrition: {
    calories: '28 kcal',
    carbs: '3.7 g',
...
const MUSKMELON: FVIClass = {
  ...
  information: [
    'Botanisch gesehen sind die Zuckermelonen (zu denen die Galiamelone gehört) mehr mit der Gurke verwandt als mit der Wassermelone'
  ],
  nutrition: {
    calories: '26 kcal',
    carbs: '5.6 g',
...
const NECTARINE: FVIClass = {
  ...
  information: [
    'Pfirsich und Nektarinen sind die gleichen Arten, auch wenn sie kommerziell als unterschiedliche Früchte betrachtet werden. Der Unterschied zwischen ihnen ist, dass Pfirsiche die unscharfe Haut haben, während Nektarinen dies nicht tun.'
  ],
  nutrition: {
    calories: '56 kcal',
    carbs: '12.4 g',
...
const ONION: FVIClass = {
  ...
  information: [
    'Wenn man eine aufgeschnittene Zwiebel auf der Fußsohle reibt, hat man etwa eine Stunde später den Geschmack von Zwiebel im Mund. Viel Spaß beim Ausprobieren ;)'
  ],
  nutrition: {
    calories: '28 kcal',
    carbs: '4.9 g',
...
const PHYSALIS: FVIClass = {
  ...
  information: [
    'In Frankreich heißen die Früchte Amour en cage- übersetzt also soviel wie Liebe in einem Käfig <3'
  ],
  nutrition: {
    calories: '77 kcal',
    carbs: '13.3 g',
...
const PITAYA: FVIClass = {
  ...
  information: [
    'Die Pitahaya hat einen positiven Einfluss auf den Cholesterinspiegel und kann somit helfen, Herzkrankheiten vorzubeugen.'
  ],
  nutrition: {
    calories: '77 kcal',
    carbs: '13.3 g',
...
const POTATO: FVIClass = {
  ...
  information: [
    ' In Deutschland gibt es drei Kartoffelmuseen: das Deutsche Kartoffelmuseum in Fußgönheim, das Kartoffelmuseum in München und das Vorpommersche Kartoffelmuseum in Tribsees.'
  ],
  nutrition: {
    calories: '71 kcal',
    carbs: '14.6 g',
...
const RAMBUTAN: FVIClass = {
  ...
  information: [
    'Achtung Fake Litchi, trotzdem ein Superfrucht! Dank des Wassers, Proteine und Kohlenhydrate liefert Rambutan einen natürlichen Energieschub, weswegen die Frucht besonders unter Sportlern wertgeschätzt wird. Dank des Eisen hilft die Rambutan auch Sauerstoff von der Lunge zum Gewebe zu transportieren. '
  ],
  nutrition: {
    calories: '71 kcal',
    carbs: '14.6 g',
...
const SWEETPOTATO: FVIClass = {
  ...
  information: [
    'Die Süßkartoffel hat mit der „normalen“ Kartoffel nicht viel gemein. Die Kartoffel ist ein Nachtschattengewächs. Die Süßkartoffel ein sogenanntes Windengewächs. Die Süßkartoffel darf roh verzehrt werden, aber die Kartoffel nicht. Von der Süßkartoffel darf sogar das Blattgrün mitgegessen werden.'
  ],
  nutrition: {
    calories: '86 kcal',
    carbs: '20 g',
...
const TOMATOES: FVIClass = {
  ...
  information: [
    'Niemand liebt die Tomate mehr als die Italiener. Deshalb haben sie auch einen ganz besonderen Namen für sie: Pomodoro – was übersetzt Goldapfel heißt.'
  ],
  nutrition: {
    calories: '18 kcal',
    carbs: '2.6 g',
...
const WATERMELON: FVIClass = {
  title: 'Wassermelone',
  thumbnail:
    'https://images.unsplash.com/photo-1530552171419-b0212487fe84?w=1920&q=20',
  information: [
    'Es wurde berichtet, dass die schwerste Wassermelone 159 kg wiegt, aber die meisten Sorten produzieren Wassermelonen von ungefähr 6 bis 12 kg (13-26 Pfund)'
  ],
  nutrition: {
    calories: '39 kcal',
    carbs: '8.3 g',
