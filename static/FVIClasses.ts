...
const FVIClasses = [APPLE, APRICOT, AVOCADO, BANANA, BEETROOT, BELLPEPPER, BLUEBERRY, BROCCOLI, CACTUS_FRUIT, CANTALOUPE, CARAMBOLA, CAULIFLOWER, CHERRY, CHESTNUT, COCOS, CORN, CUCUMBER, DATE, EGGPLANT, FIG, GINGER, GRAPE, GUAVA, KIWI, KOHLRABI, LEMON, LIME, LYCHEE, MANGO, MARACUJA, MULBERRY, MUSKMELON, NECTARINE, ONION, ORANGE, PAPAYA, PASSION_FRUIT, PEACH, PEAR, PERSIMMON, PHYSALIS, PINEAPPLE, PITAYA, PLUM, POMEGRANATE, POMELO, POTATO, RAMBUTAN, RASPBERRY, STRAWBERRY, SWEETPOTATO, TOMATOES, WATERMELON]
