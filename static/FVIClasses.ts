...
const FVIClasses = [APPLE, BANANA, BELLPEPPER, BLUEBERRY, BROCCOLI, CARAMBOLA, EGGPLANT, FIG, GINGER, GRAPE, KIWI, LEMON, LIME, ONION, ORANGE, PEAR, PLUM, POTATO, STRAWBERRY, SWEETPOTATO, TOMATOES, WATERMELON]
